 ...
 */
class CTFMeleeMobBody : public IBody
{
public:
	CTFMeleeMobBody( INextBot *bot );
...
inline Activity CTFMeleeMobBody::GetActivity( void ) const
{
	return (Activity)m_currentActivity;
}

inline bool CTFMeleeMobBody::IsActivity( Activity act ) const
{
