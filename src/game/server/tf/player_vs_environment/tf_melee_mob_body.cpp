...
//-------------------------------------------------------------------------------------------
CTFMeleeMobBody::CTFMeleeMobBody( INextBot *bot ) : IBody( bot )
{
...
//-------------------------------------------------------------------------------------------
bool CTFMeleeMobBody::StartActivity( Activity act, unsigned int flags )
{
...
//-------------------------------------------------------------------------------------------
void CTFMeleeMobBody::Update( void )
{
	CTFMeleeMob *me = (CTFMeleeMob *)GetBot()->GetEntity();
...
unsigned int CTFMeleeMobBody::GetSolidMask( void ) const
{
